...
public interface EventService {
    ...
    /**
     * Владелец события: получение списка заявок на участие в своём событии
     */
    List<UserRequestDto> getEventRequests(Long userId, Long eventId);

    /**
     * Владелец события: подтверждение или отклонение заявок на участие
     */
