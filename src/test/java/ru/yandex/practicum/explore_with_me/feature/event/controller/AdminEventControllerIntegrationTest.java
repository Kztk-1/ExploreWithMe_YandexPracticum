...
//        "/sql/test-data/events-data.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
class AdminEventControllerIntegrationTest extends BaseIntegrationTest {
